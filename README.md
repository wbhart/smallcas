...
The balanced middle-product dispatcher now uses Toom63 for every size at least
48. Multiples of 3 use the direct transform and the other two residue classes
use the diagonal/row correction above. This remains a deliberately untuned
policy.
