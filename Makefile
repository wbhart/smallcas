...
.PHONY: all clean pdf check check-lines check-functions test test-core tune
...
$(TUNER): tools/tune.c $(TUNE_CORE_OBJECTS) | $(BUILD)
...
include/tuning.h:
	@printf '%s\n' '/* Machine-local; generated by make tune. */' \
